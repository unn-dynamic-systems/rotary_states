...
* Phase period: $\text{phase\_period} = 2\pi \cdot k$
...
That system describes the perturbations $\delta\varphi_i$ and stability of zero solution $\delta\varphi_i$ determine stability of rotational regime $\psi_i$.
